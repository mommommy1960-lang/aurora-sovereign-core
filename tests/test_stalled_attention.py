import hashlib
import pytest
from aurora.attention import AttentionLedger, AttentionError
from aurora.continuity import snapshot_memory
from aurora.core import AuroraCore
from aurora.persistence import encode_snapshot
from aurora.recovery import recover_verified
from aurora.restore_ledger import RestoreLedger, RestoreRejected

KEY = b"simulation-test-key"

def test_stalled_restore_remains_visible_until_human_acknowledges(tmp_path):
    snapshot = snapshot_memory(AuroraCore(), key_id="k1", key_epoch=2)
